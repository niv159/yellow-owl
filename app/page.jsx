...
// Options are ordered best thinking → weakest thinking (scoring: 4, 3, 2, 1)
const EMERGENCY_BASE = {
  junior: {
    scenario: "Your school is running a 'Fix Our Playground' project. Students have noticed that fewer children play outside at lunch break. The school has ₹20,000 to improve things. Your class has been asked to investigate and recommend what to do.",
    stages: [
      { step: 4, label: "Find it out", q: "Before recommending anything, what is the single most useful thing to find out first?", options: ["Ask students directly why they stopped going outside — the real reason will shape the solution", "Count how many students still go outside each day, to understand how big the problem is", "Look at what other schools have done to improve their playgrounds", "Just buy new equipment straight away — that usually fixes playground problems"] },
      { step: 5, label: "Lots of ideas", q: "You found that students say the playground is 'boring' and 'too hot in the afternoon'. Which response shows the best thinking for coming up with solutions?", options: ["Think across completely different types of solutions — shading, new game areas, art corners, sports clubs", "Find two things that worked at other schools and suggest those", "Ask the most popular student in class what they would want", "Focus only on fixing the 'boring' problem since more students mentioned it"] },
      { step: 6, label: "Look closer", q: "You are comparing two ideas: a shade canopy (₹16,000) vs painted game markings on the ground (₹8,000). Which is the best way to compare them?", options: ["Think about how many students each benefits, whether each fixes the real reasons, and what could go wrong", "Work out which option fits within the ₹20,000 budget", "Ask students which one they like the look of", "Pick the shade canopy — heat was mentioned more so it must be the bigger problem"] },
      { step: 7, label: "Pick one", q: "The shade canopy (₹16,000) helps students who stay outside but won't bring back those who leave from boredom. The game markings (₹8,000) directly fix 'boring' and leave ₹12,000 for something extra. What is the best recommendation?", options: ["Recommend the game markings — they fix the main reason students leave, cost less, and leave ₹12,000 for a second improvement", "Recommend the game markings because they fix boredom and are cheaper", "Recommend the shade canopy — physical comfort in heat is a more serious need than boredom", "Spend only ₹8,000 on the game markings and save ₹12,000 — don't spend more until you see results"] },
    ],
  },
  senior: {
    scenario: "A school introduced different homework policies by class: no homework in Class 7, optional homework in Class 8, compulsory homework in Class 9. After one year: Class 7 test scores went up, Class 8 stayed the same, Class 9 scores went down.",
    stages: [
      { step: 7, label: "Best choice", q: "The principal wants to expand the no-homework policy to all classes. What is the most important thing to establish first?", options: ["Whether Class 7's improvement was actually caused by removing homework — it might have been a stronger batch or different teachers", "Whether students and parents prefer the no-homework approach", "Whether the policy saved teachers time, which might have improved teaching quality", "Roll it out — the Class 7 data clearly shows it works"] },
      { step: 9, label: "Find the cause", q: "Class 9 scores went down under compulsory homework. What is the most likely root cause?", options: ["Compulsory homework removes student choice — work done reluctantly is less effective. The mechanism is motivation, not time", "Class 9 students face more distractions at home — tuitions, phones, family pressure — making homework less productive", "Teachers assigned too much homework, leaving students stressed and performing worse in exams", "Class 9 is harder syllabus — scores naturally drop at that stage regardless of homework"] },
      { step: 10, label: "Spot the link", q: "Students who chose to do homework in Class 8 scored higher than both the no-homework AND compulsory groups. What does this pattern most likely mean?", options: ["Choice is the key variable — choosing may select motivated students OR create ownership; optional homework should outperform both extremes", "Students who choose homework are more motivated in general — the homework itself may not be the cause", "Optional homework gives the best of both worlds — some practice without compulsory pressure", "The number of voluntary students in Class 8 is probably too small to mean anything"] },
      { step: 12, label: "What next", q: "A parent argues: 'Every student who had no homework in Class 7 improved. So removing homework must improve scores.' What is the flaw?", options: ["It confuses 'all improved' with 'removal caused improvement' — without a comparison group in Class 7, you cannot isolate the policy", "The argument ignores Class 9 where compulsory homework correlated with lower scores", "Class 7 students improve naturally — marks tend to go up as students settle into a new year", "The parent is probably right — if every student improved, the policy is most likely responsible"] },
    ],
  },
};
