...
const EMERGENCY_BASE = {
  junior: {
    scenario: "Your school wants to fix the playground. Fewer students are going outside at lunch. The school has ₹20,000 to spend. Your class needs to find out what is wrong and suggest what to do.",
    stages: [
      { step: 4, label: "Find it out", q: "What should you find out first, before deciding what to do?", options: ["Ask students why they stopped going outside — that will tell you what to fix", "Count how many students still go outside each day", "See what other schools did to fix their playgrounds", "Buy new equipment straight away — it usually works"] },
      { step: 5, label: "Lots of ideas", q: "Students said the playground is 'boring' and 'too hot'. Which answer shows the best way to think of fixes?", options: ["Think of many different kinds of fixes — shade, new games, art corners, sports — not just one type", "Find two things that worked at other schools and suggest those", "Ask the most popular student what they want", "Only try to fix 'boring' since more students said that"] },
      { step: 6, label: "Look closer", q: "You have two choices: a shade cover (₹16,000) or painted game lines on the ground (₹8,000). What is the best way to pick between them?", options: ["Think about how many students each one helps, whether it fixes the real problem, and what could go wrong", "Check which one fits in the ₹20,000 budget", "Ask students which one looks better", "Pick the shade cover — more students talked about the heat so it must be worse"] },
      { step: 7, label: "Pick one", q: "The shade cover (₹16,000) helps students who already stay outside. It will not help students who leave because it is boring. The game lines (₹8,000) fix 'boring' and leave ₹12,000 to spend on something else. What should you suggest?", options: ["Choose the game lines — they fix why students leave, cost less, and leave ₹12,000 for something else", "Choose the game lines because they fix boredom and cost less", "Choose the shade cover — being cool is more important than fixing boredom", "Spend only ₹8,000 on the game lines and save the rest — wait to see if it works first"] },
    ],
  },
  senior: {
    ...
    stages: [
      { step: 7, label: "Best choice", q: "The principal wants to remove homework for all classes. What is the most important thing to check first?", options: ["Whether removing homework actually caused Class 7's improvement — it might have been a better batch or different teachers that year", "Whether students and parents want no homework", "Whether teachers had more free time because of the policy, which may have helped them teach better", "Just roll it out — the Class 7 results clearly show it works"] },
      { step: 9, label: "Find the cause", q: "Class 9 scores dropped after homework became compulsory. What is the most likely reason?", options: ["Forced homework takes away student choice — work done unwillingly is less useful. The real problem is motivation, not time spent", "Class 9 students have more things pulling their attention at home — tuitions, phones, family — so homework helps less", "Teachers gave too much homework, which stressed students and hurt their exam scores", "Class 9 has a harder syllabus — scores often drop at this stage no matter what"] },
      { step: 10, label: "Spot the link", q: "Students in Class 8 who chose to do homework scored higher than both the no-homework group and the compulsory group. What does this most likely show?", options: ["Choice is what matters — students who choose to work may already be motivated, or choosing itself makes them more engaged. Either way, optional homework should beat both groups", "Students who choose homework are probably already more hardworking — so the homework itself may not be what helped", "Optional homework gives students some practice without the stress of it being forced", "There were probably too few students who chose homework in Class 8 to draw any conclusion"] },
      { step: 12, label: "What next", q: "A parent says: 'Every Class 7 student improved after homework was removed. So removing homework must be what helped.' What is wrong with this?", options: ["Just because everyone improved doesn't mean removing homework caused it — there was no group in Class 7 who kept homework to compare with", "The argument leaves out Class 9, where compulsory homework came with lower scores", "Class 7 students often improve naturally — marks tend to go up as they settle into a new year", "The parent is probably right — if every student improved, the policy most likely caused it"] },
    ],
  },
};
