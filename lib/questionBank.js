...
//
// answer / answerExplain: only on questions where there is a clear best answer.
//   - research (step 4): what information is most useful?
//   - information (step 12): which source is most reliable?
//   - cause MCQ (step 9): which cause is most likely?
// evaluate/decision and mystery questions deliberately have no answer field —
// they are reasoning exercises where any defended choice is valid.
// analyse questions are intentionally 2 options — structured compare-two exercises.
...
export const QUESTION_BANK = {
  junior: {
    ...
    group0: [
      {
        ...
        options: [
          ...
          "Whether any of your friends will be going",
          "How many other children are signed up",
          "What the hall looks like inside",
        ],
        answer: 0,
        answerExplain: "Knowing the activities and days tells you directly whether anything interests you — that is the essential starting point. Whether friends are going or how many signed up tells you nothing about whether the activities suit you.",
      ...
      },
      {
        ...
        options: [
          ...
          "How to re-borrow the book if someone else has it now",
          "What the story in the book was about",
          "Whether anyone else has recently lost a book too",
        ],
        answer: 0,
        answerExplain: "You need to know if the book is actually overdue and if there is a fine — that is the most urgent, practical question. Knowing the story or whether others lost books does not help you sort out your own problem.",
      ...
      },
      {
        ...
        options: [
          "What skills and qualities the coaches are looking for",
          "How long training sessions are and how often they meet",
          "How many people are currently in the team",
          "What kit the team wears on match days",
        ],
        answer: 0,
        answerExplain: "Knowing what the coaches look for tells you exactly what to practise. Training schedules and team size only matter after you make the team — the selection criteria come first.",
      ...
      },
      {
        ...
        options: [
          ...
          "How much the pet and its equipment would cost",
          "Which animal looks the most interesting",
          "Whether other schools have had a similar class pet before",
        ],
        answer: 0,
        answerExplain: "Care needs come first — if you cannot properly look after the animal, it is not a suitable pet no matter how much it costs or how interesting it looks.",
      ...
      },
      {
        ...
        options: [
          ...
          "What the accommodation is like and who you would share with",
          "How many teachers are coming on the trip",
          "What other trips the school has done in previous years",
        ],
        answer: 0,
        answerExplain: "A parent needs the destination, planned activities, and cost to make a yes or no decision. Accommodation details and the number of teachers are useful context but secondary to the core facts.",
      ...
      },
      {
        ...
        options: [
          ...
          "How much it costs compared to other snacks at the canteen",
          "Who made the advert for it",
          "How many people at school have already tried it",
        ],
        answer: 0,
        answerExplain: "Ingredients and sugar content tell you directly whether it is actually healthy. Who made the advert, how many people tried it, or the price tells you nothing about its nutritional value.",
      ...
      },
      {
        ...
        options: [
          "Whether there is a safe path with no busy roads the whole way",
          "Whether there is somewhere secure to lock a bike at school",
          "How many minutes the journey takes",
          "How many other children at your school already cycle",
        ],
        answer: 0,
        answerExplain: "Safety is your parents' key concern. Only once you know the route is completely safe can you address secondary questions like journey time or bike storage.",
      ...
      },
      {
        ...
        answer: 0,
        answerExplain: "An expert author is the strongest reliability indicator. Whether the writer knows their subject matters far more than visual appeal, update dates, or a friend's recommendation.",
    ...
    // NOTE: 2 options by design — this is a structured compare-two exercise
    group2: [
      {
        type: "analyse", step: 6,
    ...
    // No answer field — any well-reasoned choice is valid
    group3: [
      {
      ...
      },
      {
        ...
        options: [
          ...
          "Outdoor stage — for drama, music, and performances",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Hamster — small and easy to feed, but most active at night",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Debate — practise public speaking and building arguments",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "School quiz — teams pay to enter and compete for prizes",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Food collection — gather donations for the local food bank",
        ],
      ...
      },
      {
        type: "evaluate", step: 7,
        title: "Science Fair",
        scenario: "Your class is entering the school science fair. You must submit one project, chosen from four approaches.",
        ...
        options: [
          ...
          "Survey — ask people questions, collect data, and present your findings",
        ],
      ...
      },
      {
        ...
        options: [
          ...
          "Herbs — fragrant, useful for cooking, and easy to grow in a small space",
        ],
  ...
  senior: {
    ...
    group0: [
      {
        ...
        scenario: "The school council has £500 to spend on one improvement to the school. Four proposals have been shortlisted.",
        prompt: "Which improvement would you recommend and why?",
        options: [
          "New library books — benefits every student who reads",
          "A quiet study and wellbeing room — any student can use it when they need a break",
      ...
      },
      {
        ...
        options: [
          ...
          "Opt-in phone locker — students choose to hand in their phone for a focus reward",
      ...
      },
      {
        ...
        scenario: "Your school wants to run one project this term to cut its environmental impact. Four options are being considered.",
        prompt: "Which project would make the biggest difference?",
        options: [
          "Switch all classroom lights to energy-saving LEDs",
          "Plant a wildflower border and run a school nature survey",
          "Start a school food-waste composting programme",
          "Run a car-free week where all staff cycle or use public transport",
        ],
        curveball: "The LED switch would save the most energy long-term but costs £2,000 upfront. The other three cost almost nothing. Does that change your choice?",
      },
      {
        type: "decision", step: 7,
        ...
        options: [
          ...
          "Reading circles — small groups choose their own book and meet weekly to discuss",
      ...
      },
      {
        ...
        options: [
          ...
          "A 3D printer and maker space corner — for creative STEM projects",
      ...
      },
      {
        ...
        options: [
          ...
          "Cross-country running club — open to all abilities, low equipment cost",
          "Wheelchair basketball group — the only sport available to students with mobility difficulties",
        ],
        curveball: "The football team just signed a kit sponsorship with a local company. The other three have no external funding at all. Does that change your answer?",
      },
      {
        type: "decision", step: 7,
        ...
        options: [
          ...
          "School council rep — voice your year group's concerns in school decisions",
        ],
      ...
      },
      {
        ...
        scenario: "Your school is considering extending the school day by one hour, three days a week.",
        prompt: "Which reason would make you most likely to support this?",
        options: [
          "Extra time given to clubs and creative activities",
          "Dedicated wellbeing sessions — mindfulness, exercise, or life skills",
    ...
    group1: [
      ...
      },
      {
        ...
        scenario: "The canteen queue is taking 20 minutes, leaving students with only 10 minutes to eat. Four things changed recently: the canteen lost one member of staff, a new hot food option was added, all year groups now have lunch at the same time, and the menu doubled in size.",
        ...
        options: [
          ...
          "Students take longer to choose because the menu is now much bigger",
        ],
        answer: 2,
        answerExplain: "All year groups arriving at the same time creates the biggest possible surge in demand all at once. A system built for staggered arrivals simply cannot cope when everyone shows up together — that structural change is the most powerful cause.",
        curveball: "The canteen manager says the queue was this long last year too, before any of these changes. What would you investigate next?",
      },
      {
        type: "cause", step: 9,
        title: "Homework Drop",
        scenario: "A teacher notices students are submitting less homework this half-term. Four things changed: a popular TV show started on the evenings homework is due, a new online game launched, homework increased from one piece to two per week, and the topics changed.",
        ...
        options: [
          ...
          "The topics changed and students are finding the new work harder",
        ],
        answer: 2,
        answerExplain: "Doubling homework from one to two pieces per week affects every single student. A TV show or game would only affect some students — it cannot explain a whole-class drop. A structural change that affects everyone is the most likely cause of a whole-class pattern.",
    ...
    // mystery: no answer field — deliberately debatable, curveball flips initial reasoning
    group3: [
      {
        type: "mystery", step: 12,
        title: "Copied Project",
        scenario: "Two students handed in almost identical science projects. They worked in separate rooms all week and did not meet outside school. Four people had access to both their files: a student helper, the IT technician, the class teacher, and a student in the same year group with access to the shared drive.",
        ...
        options: [
          ...
          "The class teacher — had full access to all files but no clear motive",
          "The classmate with shared drive access — could copy files without being seen",
        ],
      ...
      },
      {
        type: "mystery", step: 12,
        title: "Missing Money",
        scenario: "£20 went missing from the class fundraising tin. The tin was in a locked cupboard. Four people had a key or access: the class teacher, the head teacher, the school secretary, and a parent volunteer who helped set up the fundraiser that morning.",
        prompt: "Who is most likely responsible? What is your best reasoning?",
        options: [
          "The class teacher — had a key but was in a staff meeting all morning",
          ...
          "The parent volunteer — had access that morning and left before the money was noticed missing",
        ],
      ...
      },
      {
        ...
        title: "Is It Healthy?",
        scenario: "You want to find out whether a new type of snack is actually good for you. Four sources give different information.",
        ...
        options: [
          ...
          "A news article summarising several recent nutrition studies",
          "An advert from the company that makes and sells the snack",
        ],
        answer: 1,
        answerExplain: "A study by university scientists published in a health journal has been checked and reviewed by other experts before publication. A personal blog is one person's experience, a news article is a secondhand summary, and an advert exists specifically to sell you something.",
      ...
      },
      {
        ...
        scenario: "People disagree about whether homework actually helps students learn. Four sources share their view.",
        ...
        options: [
          ...
          "A parent who is also a school governor and has reviewed school data",
          "A newspaper article saying students today are overloaded with work",
        ],
        answer: 1,
        answerExplain: "The teacher has ten years of carefully tracked data — real evidence collected systematically over time. A student's personal feeling, a parent's opinion, and a newspaper summary are all less reliable because they are based on limited experience rather than systematic evidence.",
      ...
      },
      {
        ...
        scenario: "A competition poster was removed overnight from the school notice board. Four people had a reason or ability to take it: a student whose entry was rejected, the competition organiser, the caretaker who clears the board daily, and a student whose friend entered and wanted to reduce their competition.",
        prompt: "Who most likely removed it, and what is your key piece of reasoning?",
        options: [
          "The rejected student — had a clear motive since their work was not accepted",
          ...
          "The student whose friend entered — wanted to reduce competition for their friend",
        ],
